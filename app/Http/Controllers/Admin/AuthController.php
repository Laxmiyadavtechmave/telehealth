...
class AuthController extends Controller
{
    ...
    public function logout(Request $request)
    {
        ...
        return redirect()->route('superadmin.login')->header('Cache-Control', 'no-store, no-cache, must-revalidate, max-age=0')->header('Pragma', 'no-cache')->header('Expires', 'Sat, 01 Jan 2000 00:00:00 GMT');
    }
