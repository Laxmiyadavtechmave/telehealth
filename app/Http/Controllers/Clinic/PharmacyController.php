...
class PharmacyController extends Controller
{
    ...
    public function index()
    {
        try {
            ...
            return view('clinic.pharmacy.index', compact('clinics'));
        } catch (Exception $e) {
    ...
    public function ajaxDatatable(Request $request)
    {
        ...
        // Count total records
        $totalRecords = Pharmacy::where('clinic_id', $clinicId )->count();

        // Base query
        $query = Pharmacy::where('clinic_id', $clinicId );
        ...
        foreach ($records as $key => $row) {
            ...
            $data_arr[] = [
                ...
                'action' =>
                    ...
                    route('clinic.pharmacies.edit', encrypt($row->id ?? '')) .
                    '">
                    ...
                    route('clinic.pharmacies.show', encrypt($row->id ?? '')) .
                    '">
    ...
    public function create()
    {
        try {
            ...
            return redirect()->route('clinic.pharmacies.index')->with('error', 'Something went wrong');
        }
    }
    ...
    public function store(Request $request)
    {
        ...
        try {
            ...
            DB::commit();
            return redirect()->route('clinic.pharmacies.index')->with('success', 'Pharmacy created successfully!');
        } catch (\Exception $e) {
            // dd($e->getMessage());
            DB::rollback();
            return redirect()->route('clinic.pharmacies.create')->with('error', $e->getMessage())->withInput();
        }
    }
    ...
    public function show(string $id)
    {
        try {
            ...
            return view('clinic.pharmacy.detail', compact('pharmacy', 'schedules', 'extra', 'documents'));
        } catch (Exception $e) {
            return redirect()->route('clinic.pharmacies.index')->with('error', 'Something went wrong');
        }
    }
    ...
    public function edit(string $id)
    {
        try {
            ...
            return view('clinic.pharmacy.edit', compact('pharmacy', 'schedules', 'clinics', 'extra', 'documents'));
        } catch (Exception $e) {
            return redirect()->route('clinic.pharmacies.index')->with('error', 'Something went wrong');
        }
    }
    ...
    public function update(Request $request, $id)
    {
        ...
        try {
            ...
            DB::commit();
            return redirect()->route('clinic.pharmacies.index')->with('success', 'Pharmacy updated successfully!');
        } catch (\Exception $e) {
            DB::rollback();
            return redirect()->route('clinic.pharmacies.edit', encrypt($id))->with('error', $e->getMessage())->withInput();
        }
    }
