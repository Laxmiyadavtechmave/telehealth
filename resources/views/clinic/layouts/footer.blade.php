                    ...
                    <div class="modal-header modalheader_customStyle">
                        <h5 class="modal-title" id="exampleModalLabel">
                            <div class="modaltitle_icon">
                               <img src="{{ asset('clinic/img/newimages/add-to-basket.png') }}" alt="">
                            </div>
                    ...
                    <div class="modal-body">
                        <div class="selectedtype_container">
                            ...
                            <div class="card cardforAcFire" data-form-type="single">
                                <div class="card-content">
                                    <div class="formtypecard_icon">
                                        <img src="{{ asset('clinic/img/newimages/box(1).png') }}" alt="">
                                    </div>
                            ...
                            <div class="card CardDual" data-form-type="combo">
                                <div class="card-content">
                                    <div class="formtypecard_icon">
                                        <img src="{{ asset('clinic/img/newimages/products.png') }}" alt="">
                                    </div>
...
<!-- jQuery -->
<script src="{{ asset('clinic/js/jquery-3.7.1.min.js') }}"></script>
<!-- iconify icon -->
<script src="{{ asset('clinic/js/iconify.js') }}"></script>
<!-- Feather Icon JS -->
<script src="{{ asset('clinic/js/feather.min.js') }}"></script>
<!-- Slimscroll JS -->
<script src="{{ asset('clinic/js/jquery.slimscroll.min.js') }}"></script>
<!-- Bootstrap Core JS -->
<script src="{{ asset('clinic/js/bootstrap.bundle.min.js') }}"></script>
<!-- Chart JS -->
<script src="{{ asset('clinic/plugins/apexchart/apexcharts.min.js') }}"></script>
<script src="{{ asset('clinic/plugins/apexchart/chart-data.js') }}"></script>
<!-- Sweetalert 2 -->
<script src="{{ asset('clinic/plugins/sweetalert/sweetalert2.all.min.js') }}"></script>
<script src="{{ asset('clinic/plugins/sweetalert/sweetalerts.min.js') }}"></script>
<!-- dropify -->
<script type="text/javascript" src="{{ asset('clinic/js/dropify.min.js') }}"></script>
<link rel="stylesheet" type="text/css" href="css/dropify.min.css">
<!-- Datatable JS -->
<script src="{{ asset('clinic/js/jquery.dataTables.min.js') }}"></script>
<script src="{{ asset('clinic/js/dataTables.bootstrap5.min.js') }}"></script>
<script src="{{ asset('clinic/js/contact-data.js') }}"></script>
<!-- Datetimepicker JS -->
<link rel="stylesheet" href="https://cdn.jsdelivr.net/npm/flatpickr/dist/flatpickr.min.css">
<script src="https://cdn.jsdelivr.net/npm/flatpickr"></script>
<script src="{{ asset('clinic/js/daterangepicker-data.js') }}"></script>
<!-- Data Table JS -->
...
<script src="{{ asset('clinic/vendors/datatables.net-select/js/dataTables.select.min.js') }}"></script>

<!-- Mobile Input -->
<link rel="stylesheet" href="{{ asset('clinic/plugins/intltelinput/css/intlTelInput.css') }}">
<link rel="stylesheet" href="{{ asset('clinic/plugins/intltelinput/css/demo.css') }}">
<script src="{{ asset('clinic/plugins/intltelinput/js/intlTelInput.js') }}"></script>
<!-- Custom Datatable js start -->
<link rel="stylesheet" type="text/css" href="{{ asset('clinic/customplugins/buttons.dataTables.min.css') }}">
<script type="text/javascript" src="{{ asset('clinic/customplugins/dataTables.buttons.min.js') }}"></script>
<script type="text/javascript" src="{{ asset('clinic/customplugins/jszip.min.js') }}"></script>
<script type="text/javascript" src="{{ asset('clinic/customplugins/pdfmake.min.js') }}"></script>
<script type="text/javascript" src="{{ asset('clinic/customplugins/vfs_fonts.js') }}"></script>
<script type="text/javascript" src="{{ asset('clinic/customplugins/buttons.html5.min.js') }}"></script>
<script type="text/javascript" src="{{ asset('clinic/customplugins/buttons.colVis.min.js') }}"></script>
<!-- Select2 JS -->
<script src="{{ asset('clinic/plugins/select2/js/select2.min.js') }}"></script>
<!-- Daterangepikcer JS -->
<script src="{{ asset('clinic/js/moment.js') }}"></script>
<!-- Custom JS -->
<script src="{{ asset('clinic/js/script.js') }}" type=""></script>
<!-- Custom JS -->
<script src="{{ asset('clinic/js/theme-script.js') }}"></script>
<!-- Datetimepicker JS -->
<script src="{{ asset('clinic/js/bootstrap-datetimepicker.min.js') }}" type=""></script>
<!-- Daterangepikcer JS -->
<script src="{{ asset('clinic/plugins/daterangepicker/daterangepicker.js') }}" type=""></script>

<script src="{{ asset('clinic/js/custom-select2.js') }}"></script>
...
<link rel="stylesheet" href="css/lightbox.min.css">
  <script src="{{ asset('clinic/') }}js/lightbox.min.js"></script>
