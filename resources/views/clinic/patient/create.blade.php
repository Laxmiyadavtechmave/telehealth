        ...
        <div class="content">
            ...
            <div class="rightSideWrapper">
                ...
                <div class="tablemaincard_nopaddingleftright">
                    <form action="{{ route('clinic.patient.store') }}" class="form needs-validation" method="post"
                                                    ...
                                                    <div class="col-lg-6">
                                                        <div class="form-group">
                                                            ...
                                                            <input type="text" placeholder="Name" id="name"
                                                                ...
                                                                value="{{ old('extra.emergency_name') }}" required>
                                                        </div>
                                                    </div>
                                                    <div class="col-lg-6">
                                                        <div class="form-group">
                                                            ...
                                                            <input type="text" placeholder="Relation" id="name"
                                                                ...
                                                                value="{{ old('extra.emergency_relation') }}" required>
                                                        </div>
                                                    </div>
                                                    <div class="col-lg-6">
                                                        <div class="form-group">
                                                            ...
                                                            <input type="text" placeholder="Phone" id="name"
                                                                ...
                                                                value="{{ old('extra.emergency_phone') }}" maxlength="13"
                                                                minlength="8"
                                                                oninput="this.value = this.value.replace(/[^0-9]/g, '').slice(0,13);"
                                                                pattern="\d{8,13}" required>
                                                        </div>
                                                    ...
                                                    <div class="col-lg-6">
                                                        <div class="form-group">
                                                            ...
                                                            <input type="text" placeholder="Email" id="name"
                                                                ...
                                                                value="{{ old('extra.emergency_email') }}">
                                                        </div>
                                                    </div>
                                                    ...
                                                    <div class="col-lg-6">
                                                        <div class="form-group">
                                                            ...
                                                            <input type="text" placeholder="Insurance provider"
                                                                ...
                                                                value="{{ old('extra.insurance_provider') }}">
                                                        </div>
                                                    </div>
                                                    <div class="col-lg-6">
                                                        <div class="form-group">
                                                            ...
                                                            <input type="text" placeholder="Card number"
                                                                id="name" class="form-control" name="extra[card_number]"
                                                                value="{{ old('extra.card_number') }}">
                                                        </div>
                                                    </div>
                                                    <div class="col-lg-6">
                                                        <div class="form-group">
