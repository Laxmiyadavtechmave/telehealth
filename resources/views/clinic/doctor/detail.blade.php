                    ...
                    <div class="doctor-widget doctor-profile-two">
                        <div class="doc-info-left">
                            <div class="doctor-img">
                                <img src="assets/img/newimages/doc-profile-02.png" class="img-fluid" alt="User Image">
                            </div>
                            <div class="doc-info-cont">
                                <!-- <span class="badge doc-avail-badge"><i class="fa-solid fa-circle"></i>Available </span> -->
                                <h4 class="doc-name">Dr.Martin Adian <img src="assets/img/newimages/badge-check.svg" alt="Img"><span class="badge doctor-role-badge"><i class="fa-solid fa-circle"></i>Therapist</span></h4>
                        ...
                        <div class="middle-info CommonCardPT">
                            ...
                            <!-- <div class="InfoDt">
                              <iconify-icon icon="carbon:building"></iconify-icon> Fortis Clinic & Care
                            </div> -->
                        </div>
                        <div class="middle-info CommonCardPT">
        ...
        <div class="row">
            <div class="col-lg-3">
                ...
                <div class="VitalHeader">
                            <h5 class="VitalTitle">Professional Availability <span>Last Update : 22/04/2025 02:23 PM</span></h5>
                            <a href="#" data-bs-toggle="modal" data-bs-target="#MangeSchedulePop" class="UploadBtn ManageBtn">
...
<div class="WindowsStyleModal">
    <form action="#" id="supportTicketForm">
        <div class="modal fade" id="MangeSchedulePop" tabindex="-1" aria-labelledby="HelpPopupLabel" aria-hidden="true">
