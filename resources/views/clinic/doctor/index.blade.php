            ...
            <div
                ...
                <div class="d-flex my-xl-auto right-content align-items-center flex-wrap ">
                    <div class="ActionWrapper">
                        <a href="{{ route('clinic.doctor.create') }}" class="btn btn-primary d-flex align-items-center cmnaddbtn">
                    ...
                    <div class="TableMainWrap">
                        <table class="table common-datatable nowrap w-100">
                            ...
                            <tr>
                                ...
                                <td>Cardiology</td>
                                <td>5 Years</td>
                                <td><span class="consultaionType">Audio</span><span class="consultaionType">Video</span><span class="consultaionType">Chat</span><span class="consultaionType">Physical</span></td>
                                <td>Pro Health Clinic</td>
                                <td>
                                <div class="dropdown status-dropdown d-inline-block">
                                    <button class="badge bg-soft-success dropdown-toggle border-0" type="button" data-bs-toggle="dropdown" aria-expanded="false">
                                        Active
                                    </button>
                                    <ul class="dropdown-menu">
                                        <li><a class="dropdown-item status-option" data-status="Active">Active</a></li>
                                        <li><a class="dropdown-item status-option" data-status="Inactive">Inactive</a></li>
                                    </ul>
                                    </div>
                                </td>
                                <td>
                                    <div class="d-flex align-items-center ActionDropdown">
                                        <div class="d-flex">
                                         <a class="btn btn-icon btn-flush-dark btn-rounded flush-soft-hover" data-bs-toggle="tooltip" title="Edit Doctor Detail" href="doctor-edit.php">
                                            ...
                                            <a class="btn btn-icon btn-flush-dark btn-rounded flush-soft-hover" data-bs-toggle="tooltip" title="View Doctor Detail" href="doctor-detail.php">
                            ...
                            <tr>
                                ...
                                <td>Pediatrics</td>
                                <td>3 Years</td>
                                <td><span class="consultaionType">Audio</span><span class="consultaionType">Video</span></td>
                            ...
                            <tr>
                                ...
                                <td>Orthopedics</td>
                                <td>8 Years</td>
                                <td><span class="consultaionType">Video</span><span class="consultaionType">Chat</span></td>
                                <td>Prime Wellness Clinic</td>
                                <td>
                                <div class="dropdown status-dropdown d-inline-block">
                                    <button class="badge bg-soft-danger dropdown-toggle border-0" type="button" data-bs-toggle="dropdown" aria-expanded="false">
                                        Inactive
                                    </button>
                                    <ul class="dropdown-menu">
                                        <li><a class="dropdown-item status-option" data-status="Active">Active</a></li>
                            ...
                            <tr>
                                ...
                                <td>Dermatology</td>
                                <td>6 Years</td>
                                <td><span class="consultaionType">Audio</span><span class="consultaionType">Chat</span></td>
                            ...
                            <tr>
                                ...
                                <td>Radiology</td>
                                <td>2 Years</td>
                                <td><span class="consultaionType">Audio</span><span class="consultaionType">Video</span><span class="consultaionType">Chat</span></td>
