...
@section('title', 'Tele Health Clinic Admin | Role-edit')
@section('content')
                    ...
                    <div class="container">
                        <div class="row">
                            <div class="col-lg-10 mx-auto">
                                <form action="{{ route('superadmin.role.update',encrypt($role->id)) }}" method="POST">
                                    @csrf
                                    @method('PUT')
                                    <div class="row">
                                                                                    ...
                                                                                    @foreach ($perms as $permission)
                                                                                        <div
                                                                                            ...
                                                                                            <input
                                                                                                ...
                                                                                                {{ in_array($permission->name, old('permissions', $assignedPermissions ?? [])) ? 'checked' : '' }}>
                                                                                            <label
