...
@section('title', 'Tele Health Super Admin | Details-Nurse')
@section('content')
                    ...
                    <div class="my-auto ">
                        <h2 class="mb-1 flexpagetitle">
                            <div class="backbtnwrap">
                                <a href="{{ route('superadmin.nurses.list') }}">
                ...
                <div class="card doc-profile-card">
                    <div class="card-body">
                        <div class="doctor-widget doctor-profile-two">
                            <div class="doc-info-left">
                                <div class="doctor-img">
                                    <img src="assets/img/newimages/healthcare-workers-preventing-vi.png" class="img-fluid"
                                        alt="User Image">
                                </div>
                                <div class="doc-info-cont">
                                    <!-- <span class="badge doc-avail-badge"><i class="fa-solid fa-circle"></i>Available </span> -->
                                    <h4 class="doc-name">David Miller <img src="assets/img/newimages/badge-check.svg"
                                            alt="Img"><span class="badge doctor-role-badge"><i
                                                class="fa-solid fa-circle"></i> Sr. Nurse</span></h4>
                            ...
                            <div class="doc-info-right">
                                <div class="middle-info CommonCardPT">
                                    ...
                                    <div class="InfoDt">
                                        <iconify-icon icon="ion:location-outline"></iconify-icon> 900 Oak Ridge CIR,
                                        Brighton, MI 48116
                                    </div>
                                    <div class="InfoDt">
                                    ...
                                    <div class="InfoDt">
                                        <iconify-icon icon="healthicons:doctor-male-outline" width="18"
                                            height="18"></iconify-icon> DR. Rachel Green
                                    </div>
                                </div>
                                <div class="middle-info CommonCardPT">
                        ...
                        <iconify-icon icon="hugeicons:new-job"></iconify-icon>
                                    ...
                                    <div class="InfoDt">
                                        <iconify-icon icon="hugeicons:license-third-party"></iconify-icon> RN-CA-2025-00123
                                        (07 May, 2020 - 07 May, 2030)
                                    </div>
                                    <div class="InfoDt">
                    ...
                    <div class="vitalsMainWrapper mt-2">
                        <div class="vitalsWrapper">
                            <div class="VitalHeader">
                                <h5 class="VitalTitle">Files & Documents <span>Last Update : 22/04/2025 02:23 PM</span>
                                </h5>
