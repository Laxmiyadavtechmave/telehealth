...
@section('title', 'Tele Health Super Admin | Edit Pharmacy')
@section('content')
        ...
        <div class="content">
            ...
            <div class="rightSideWrapper">
                ...
                <div class="tablemaincard_nopaddingleftright">
                    <form action="{{ route('superadmin.pharmacies.update', encrypt($pharmacy->id)) }}"
                                                                    ...
                                                                    <div class="col-lg-6">
                                                                        <div class="form-group">
                                                                            ...
                                                                            <input type="text"
                                                                                ...
                                                                                name="license_no"
                                                                                value="{{ old('license_no') ?? ($pharmacy->license_no ?? '') }}"
                                                                                required>
                                                                        </div>
                                                                    </div>
                                                                    <div class="col-lg-3">
                                                                        <div class="form-group">
                                                                            ...
                                                                            <input type="text" placeholder="Valid From"
                                                                                ...
                                                                                name="valid_from"
                                                                                value="{{ old('valid_from') ?? ($pharmacy->valid_from ?? '') }}"
                                                                                required>
                                                                        </div>
                                                                    </div>
                                                                    <div class="col-lg-3">
                                                                        <div class="form-group">
                                                                            ...
                                                                            <input type="text" placeholder="Valid To"
                                                                                ...
                                                                                class="form-control customdataPicker"
                                                                                name="valid_to"
                                                                                value="{{ old('valid_to') ?? ($pharmacy->valid_to ?? '') }}"
                                                                                required>
                                                                        </div>
                                                                    </div>
                                                                    <div class="col-lg-12">
                                                    ...
                                                    <div class="col-lg-4">
                                                        <div class="form-group">
                                                            ...
                                                            <input type="text" name="pharmacy_type" id="pharmacy_type"
                                                                ...
                                                                class="form-control"
                                                                value="{{ old('pharmacy_type') ?? ($pharmacy->pharmacy_type ?? '') }}">
                                                        </div>
                                                    </div>
                                                    <div class="col-lg-4">
                                                        <div class="form-group">
                                                            ...
                                                            <select name="clinic_id" id="clinic_id" class="select">
                                                                ...
                                                                @isset($clinics)
                                                                    @foreach ($clinics as $row)
                                                                        <option value="{{ $row->id ?? '' }}"
                                                                            {{ old('clinic_id', $pharmacy->clinic_id) == $row->id ? 'selected' : '' }}>
                                                                            {{ $row->name ?? '' }}</option>
                                                                    @endforeach
                                                                @endisset
                                                            </select>
                                                                ...
                                                                <div class="col-lg-6">
                                                                    <div class="form-group">
                                                                        ...
                                                                        <input type="text" placeholder="Address 1"
                                                                            ...
                                                                            name="address1"
                                                                            value="{{ old('address1') ?? ($pharmacy->address1 ?? '') }}"
                                                                            required>
                                                                    </div>
                                                                </div>
                                                                <div class="col-lg-6">
                                                                    <div class="form-group">
                                                                        ...
                                                                        <input type="text"
                                                                            ...
                                                                            name="address2"
                                                                            value="{{ old('address2') ?? ($pharmacy->address2 ?? '') }}">
                                                                    </div>
                                                                </div>
                                                                <div class="col-lg-4">
                                                                    <div class="form-group">
                                                                ...
                                                                <div class="col-lg-4">
                                                                    <div class="form-group">
                                                                        ...
                                                                        <input type="text" placeholder="Country"
                                                                            ...
                                                                            name="country"
                                                                            value="{{ old('country') ?? ($pharmacy->country ?? '') }}"
                                                                            required>
                                                                    </div>
                                                                </div>
                                                                <div class="col-lg-4">
                                                                ...
                                                                <div class="col-lg-12">
                                                                    <div class="form-group">
                                                                        ...
                                                                        <input type="text"
                                                                            ...
                                                                            value="{{ old('map_link') ?? ($pharmacy->map_link ?? '') }}"
                                                                            class="form-control">
                                                                    </div>
                                                                </div>
                                                            </div>
                                                                ...
                                                                <div class="tab-pane fade {{ $index === 0 ? 'show active' : '' }}"
                                                                    ...
                                                                    <div class="day-row" id="{{ $day }}">
                                                                        ...
                                                                        <button type="button"
                                                                            ...
                                                                            onclick="addSlot('{{ $day }}')" {{ $dayAvailable ? '' : 'disabled' }}>
                                                                            <iconify-icon
