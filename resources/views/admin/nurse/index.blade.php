            ...
            <div
                ...
                <div class="d-flex my-xl-auto right-content align-items-center flex-wrap ">
                    <div class="ActionWrapper">
                        <!-- <a href="nurse-add.php" class="btn btn-primary d-flex align-items-center cmnaddbtn">
                    ...
                    <div class="TableMainWrap">
                        <table class="table common-datatable nowrap w-100">
                            ...
                            <tr>
                                ...
                                <td>20 April, 2025</td>
                                <td>
                                    <span class="badge bg-soft-success" data-bs-toggle="tooltip" data-placement="top" title="Nurse is currently active">Active</span>
                                </td>
                                <td>
                                    <div class="d-flex align-items-center ActionDropdown">
                                        <div class="d-flex">
                                            ...
                                            <a class="btn btn-icon btn-flush-dark btn-rounded flush-soft-hover" data-bs-toggle="tooltip" title="View Nurse Detail" href="nurse-detail.php">
                            ...
                            <tr>
                                ...
                                <td>18 April, 2025</td>
                                <td>
                                    <span class="badge bg-soft-danger" data-bs-toggle="tooltip" data-placement="top" title="Nurse is currently inactive">Inactive</span>
                                </td>
                                <td>
                                    <div class="d-flex align-items-center ActionDropdown">
                                        <div class="d-flex">
