...
(function () {
    ...
    if ($(".custom-input").length > 0) {
        ...
        inputRange.addEventListener("input", function () {
            ...
            inputRange.style.background =
                "linear-gradient(to top, var(--md-sys-color-on-surface-variant) 0%, var(--md-sys-color-on-surface-variant) "
                    .concat(progress, "%, var(--md-sys-color-surface-variant) ")
                    .concat(
                        progress,
    ...
    if ($(".btnFullscreen").length > 0) {
        ...
        var btnFullscreenElements =
            document.getElementsByClassName("btnFullscreen"); // Add an event listener to each element
    ...
    var DIV_CARD = ".card";
    var cardFullscreenBtn = document.querySelectorAll(
    ...
    var cardRemoveBtn = document.querySelectorAll(
