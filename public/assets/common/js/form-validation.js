    ...
    document.addEventListener("DOMContentLoaded", function () {
        ...
        $("form").on("submit", function (event) {
            ...
            form.find("[required]").each(function () {
                ...
                // Handle Select2 (both single and multiple)
                if (field.hasClass("select2-hidden-accessible")) {
                    ...
                    if (isEmpty) {
                        ...
                        if (!field.next(".select2-container").next(".invalid-feedback").length) {
                            field
                                .next(".select2-container")
                ...
                // File input
                    ...
                    if (!field[0].files.length) {
                        ...
                        field.closest(".pic-holder").addClass("is-invalid");
        ...
        $("form").on("input change focus", "[required]", function () {
            ...
            if (field.hasClass("select2-hidden-accessible")) {
                ...
                if (value && (!Array.isArray(value) || value.length > 0)) {
                    ...
                    field.next(".select2-container").next(".invalid-feedback").remove();
                }
            }

            // Radio/checkbox cleanup
            else if (field.attr("type") === "radio" || field.attr("type") === "checkbox") {
                if ($("input[name='" + field.attr("name") + "']:checked").length) {
                    $("input[name='" + field.attr("name") + "']").removeClass("is-invalid");
                }
            }
            ...
            // File input cleanup
                ...
                field.closest(".pic-holder").removeClass("is-invalid");
            }
